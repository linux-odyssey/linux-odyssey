    ...
    <div class="h-screen w-screen absolute top-0 left-0">
      ...
      <main class="w-full h-full overflow-y-auto">
        <div class="w-full flex flex-col items-center">
          ...
          >
            <h1 class="text-text-primary text-7xl font-extrabold">Linux</h1>
            <img src="../img/icon_totem.svg" class="h-[30vh]" />
            <h1 class="text-text-primary text-7xl font-extrabold">Odyssey</h1>
          </div>
          <!-- intro -->
          <div class="w-full md:w-2/3 px-5">
            <section
              id="intro"
              class="text-text grid grid-cols-1 gap-3 justify-items-center"
            >
              <h1
            ...
            >
              ...
              >
                <img
                  src="../img/icon_shuttle.svg"
                  class="h-[18vh] row-span-2"
                />
                <h1
                  class="text-text-primary p-5 font-extrabold col-span-2"
              ...
              >
                <img
                  src="../img/icon_settings.svg"
                  class="h-[18vh] row-span-2"
                />
                <h1
                  class="text-text-primary p-5 font-extrabold col-span-2 pt-8"
                  style="font-size: 3.5vh"
                >
                  {{ t('landing.feature3') }}
                </h1>
            ...
            >
              <div class="w-full flex flex-col items-center gap-2">
                <h1 class="text-text-primary text-3xl font-extrabold">
                  {{ t('landing.team_intro') }}
                </h1>
                <p class="text-lg">
                  {{ t('landing.team_desc') }}
                </p>
                <div class="flex flex-row gap-5 justify-center">
                  <h1 class="font-bold">{{ t('landing.team_member1') }}</h1>
                  <h1 class="font-bold">{{ t('landing.team_member2') }}</h1>
                  <h1 class="font-bold">{{ t('landing.team_member3') }}</h1>
                  <h1 class="font-bold">{{ t('landing.team_member4') }}</h1>
                </div>
              </div>
              <div class="w-full flex flex-col items-center gap-2">
                <h1 class="text-text-primary text-3xl font-extrabold">
                ...
                <h1 class="text-xl text-center">
                  {{ t('landing.award_desc') }}
                </h1>
              </div>
              <div class="container mx-auto">
                <div
                  class="justify-items-center grid grid-cols-1 sm:grid-cols-3 gap-5"
                >
                  <h1
                    class="text-text-primary text-3xl font-extrabold sm:col-span-3 gap-6"
                  >
                    {{ t('landing.player_feedback') }}
                    <!--可以做成翻頁卡牌一次一個-->
                  </h1>
                  <h1 class="text-xl text-center">
                    {{ t('landing.feedback1') }}
          ...
          >
            <h1 class="text-text-primary font-extrabold text-3xl">
